...
export default function ThanksPage() {
     ...
     return (
          <div className="relative font-inter py-[120px] min-h-[85vh] flex flex-col justify-center overflow-hidden dark:bg-black-1000 bg-white z-10">
               <div
               ...
               <div className="max-w-[498px] text-center w-full mx-auto md:px-5 px-4">
                    <img
                         src="images/logo.png"
                         className="inline-block mb-6 w-12 h-12 rounded-xl"
                         alt=""
                    />
